import { c as M, e as w, U as F, a as P, M as v, l as f, t as K, R as O } from "./editor.main-CrAYauXT.js";
class E {
  constructor(e, t) {
  ...
  _getClient() {
    return this._client || (this._client = (async () => (this._worker = M({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "/material/te/assets/ts.worker-CtTJ3hNN.js",
        import.meta.url
      ), { type: "module" }),
      label: this._modeId,
      keepIdleModels: !0,
...
//# sourceMappingURL=tsMode-DcvaapbS.js.map
