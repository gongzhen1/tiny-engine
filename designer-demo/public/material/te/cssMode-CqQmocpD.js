import { c as h, l as s } from "./editor.main-CrAYauXT.js";
import { C as c, H as u, D as p, a as m, R as f, b as _, c as w, d as k, F as v, e as D, S as P, f as R, g as I } from "./lspLanguageFeatures-DMIHpz_c.js";
import { h as b, i as H, j as y, t as U, k as T } from "./lspLanguageFeatures-DMIHpz_c.js";
const C = 120 * 1e3;
class A {
  constructor(n) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = h({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "/material/te/assets/css.worker-C7FogG4G.js",
        import.meta.url
      ), { type: "module" }),
...
//# sourceMappingURL=cssMode-CqQmocpD.js.map
