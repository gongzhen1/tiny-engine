import { c as z, l as _, e as B } from "./editor.main-CrAYauXT.js";
import { f as J, g as Q, C as Y, H as y, b as G, d as X, F as Z, S as $, e as K } from "./lspLanguageFeatures-DMIHpz_c.js";
import { a as Ae, D as Oe, h as Ie, R as Le, c as Ne, i as Ee, j as Ue, t as De, k as Be } from "./lspLanguageFeatures-DMIHpz_c.js";
const x = 120 * 1e3;
class C {
  constructor(i) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = z({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "/material/te/assets/json.worker-CMC9kgPL.js",
        import.meta.url
      ), { type: "module" }),
...
//# sourceMappingURL=jsonMode-BfScrCeg.js.map
